                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            logFirebaseEvent(
                                'ResetPassword-Button_validate_form');
                            if (_model.formKey.currentState == null ||
                                !_model.formKey.currentState!.validate()) {
                              return;
                            }
                            logFirebaseEvent('ResetPassword-Button_auth');
                            ...
                            logFirebaseEvent(
                                'ResetPassword-Button_show_snack_bar');
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                            ...
                            logFirebaseEvent(
                                'ResetPassword-Button_navigate_to');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'FORGOT_PASSWORD_Login-ForgotPassword_ON_');
                            logFirebaseEvent(
                                'Login-ForgotPassword_navigate_back');
                            context.safePop();
                          },
                          child: Text(
                            '<- Back',
