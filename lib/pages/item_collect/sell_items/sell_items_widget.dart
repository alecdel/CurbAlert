                        ...
                        return GridView.builder(
                          ...
                          itemBuilder: (context, gridViewIndex) {
                            ...
                            return wrapWithModel(
                              model: _model.item1Models1.getModel(
                                gridViewItemsRecord.name,
                                gridViewIndex,
                              ),
                              ...
                              child: Item1Widget(
                                key: Key(
                                  'Keyc8m_${gridViewItemsRecord.name}',
                                ),
                        ...
                        return GridView.builder(
                          ...
                          itemBuilder: (context, gridViewIndex) {
                            final gridViewItemsRecord =
                                gridViewItemsRecordList[gridViewIndex];
                            return wrapWithModel(
                              model: _model.item1Models2.getModel(
                                gridViewItemsRecord.name,
                                gridViewIndex,
                              ),
                              updateCallback: () => safeSetState(() {}),
                              ...
                              child: Item1Widget(
                                key: Key(
                                  'Keyg1v_${gridViewItemsRecord.name}',
                                ),
                                items: gridViewItemsRecord,
                              ),
                            );
